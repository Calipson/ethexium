...
export const buildDockerComposeYml = (options: BuildOptions) => {
    const basePath = options.tokenType === 'ERC20' ? '/trade' : '/gameexchange';
...
services:${isGanache ? ganacheService : ''}
  frontend:
    image: https://github.com/Calipson/launch-kit-frontend:latest
    environment:
  ...
  backend:
    image: https://github.com/Calipson/launch-kit-backend:latest
    environment:
        HTTP_PORT: '3000'
